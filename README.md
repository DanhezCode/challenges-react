Challenge completed, I placed all the code in the same RecipientsDisplay file for testing purposes, although the ideal would be to have separate files and even custom hooks with the logic separately, the code is commented and I hope it meets the requirements, phone number to contact me +5356556178 o email tradersdecuba@gmail.com | danhezcode@gmail.com, If necessary I can explain the entire thought process that led me to stay with the specific solution given, do not hesitate to contact me if you have any questions.
